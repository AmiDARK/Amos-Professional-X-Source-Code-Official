...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Include    "src/AmosProAGA_Verif.s"

; Charge le moniteur et l''editeur en mode debug
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    IFNE    Debug=2
Mon_Debug:
    Include    "src/AMOSPro_Monitor/AmosProAGA_Monitor.s"
Edit_Debug:
    Include    "src/AMOSPro_Editor/AmosProAGA_Editor.s"
    ENDC
    IFEQ    Debug=2
Mon_Debug
Edit_Debug
...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    move.l    SP_DosBase(sp),a6
    lea    LibName2(pc),a0        APSystemAGA/AmosProAGA.library
    move.l    a0,d1
    jsr    _LVOLoadSeg(a6)
    tst.l    d0
    bne.s    .Ok
    lea    LibName3(pc),a0        libs/AmosProAGA.library
    move.l    a0,d1
    jsr    _LVOLoadSeg(a6)
    tst.l    d0
    bne.s    .Ok
    lea    LibName1(pc),a0        libs:AmosProAGA.library
    move.l    a0,d1
    jsr    _LVOLoadSeg(a6)
    tst.l    d0
    bne.s    .Ok
...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    tst.b    (a0)
    bne.s    .Conf
    lea    NDatas1(pc),a0            AMOSProAGA_Interpretor_Config
    move.l    a0,d1
    jsr    D_OpenD1
    bne.s    .Open
    lea    NDatas3(pc),a0            s/AMOSProAGA_Interpretor_Config
    move.l    a0,d1
    jsr    D_OpenD1
    bne.s    .Open
    lea    NDatas2(pc),a0            s:AMOSProAGA_Interpretor_Config
.Conf    move.l    a0,d1
    jsr    D_OpenD1
    bne.s    .Open
...
NDatas2:
    dc.b       "s:"
NDatas1:
    dc.b       "AMOSProAGA_Interpreter_Config",0
NDatas3:
    dc.b       "s/AMOSProAGA_Interpreter_Config",0
LibName1:
    dc.b       "libs:AMOSProAGA.library",0
LibName2:
    dc.b       "APSystemAGA/AMOSProAGA.library",0
LibName3:
    dc.b       "libs/AMOSProAGA.library",0
IconName:
    dc.b       "icon.library",0
...
AssCall:
    dc.b       "c:assign ",0 
Ass0:
    dc.b       "AMOSProAGA_System:",0
    dc.b       0
Ass1:
    dc.b       "AMOSProAGA_Accessories:",0
    dc.b       "Accessories",0
Ass2:
    dc.b       "AMOSProAGA_Productivity1:",0
    dc.b       "Productivity1",0
Ass3:
    dc.b       "AMOSProAGA_Productivity2:",0
    dc.b       "Productivity2",0
Ass4:
    dc.b       "AMOSProAGA_Tutorial:",0
    dc.b       "Tutorial",0
Ass5:
    dc.b       "AMOSProAGA_Examples:",0
    dc.b       "Examples",0
Ass6:
    dc.b       "AMOSProAGA_Compiler:",0
    dc.b       "Compiler",0
Ass7:
    dc.b       "AMOSProAGA_Extras:",0
    dc.b       "Extras",0
AssCon:
    dc.b       "NIL:",0
...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Panic_APSystem:
    dc.b       "Cannot find APSystemAGA folder.",0
Panic_Lib:
       dc.b    "Cannot find AMOSProAGA.library.",0
Panic_Config:
    dc.b       "Cannot find AMOSProAGA_Interpreter_Config.",0
Panic_Command:
    dc.b       "Bad command line.",0
Panic_Cantread:
    dc.b       "Cannot read system files: check APSystemAGA folder.",0
Panic_Badext:
    dc.b       "Cannot load extension: use default interpreter config.",0
Panic_Version:
    dc.b       "I need AMOSProAGA.library V1.0 or over!",0
        even

;        Adresses des routines accessibles aux extensions
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
AMOSJmps:
    Include    "Internal_Jumps.s"
