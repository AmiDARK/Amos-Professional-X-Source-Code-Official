...
getRainbowD1Adress:
    ...
    bcc        RainbowError            ; D0 > 3 -> Jump Error -> Wrong Rainbow Identification Number
...
TRVar 
    ...
    move.l     d0,a1                       ; a1 = d0
    tst.l      d2                          ; is d2 < = > 0 ?
    bmi        RainbowError                ; if d2 < 0 Then Jump RainbowError
    lsl.w      #1,d2                       ; d2 = d2 * 2
...
; **************** Create the new Rainbow
    ...
    move.l     a0,a1                   ; A1 = A0 = Rainbow Structure Buffer Adress
